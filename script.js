...
fr: {
  ...
  'groupe.struct.card2':'Construction, Trade, Logistics, Immobilier, Agro, Médias. Chacune constituée en SASU à Lomé, associé unique : BUAME GROUP SAS.',
  ...
  'filiale.trade.name':'TRADE', 'filiale.trade.full':'BUAME Trade',
  'filiale.trade.desc':"Import-export, distribution B2B, commerce général, BUAME Market. Fournisseur exclusif des 5 autres filiales.",
...
en: {
  ...
  'groupe.struct.card2':'Construction, Trade, Logistics, Real Estate, Agro, Media. Each incorporated as a SASU in Lomé, sole shareholder: BUAME GROUP SAS.',
  'groupe.struct.card3.title':'SARL / Ltd — Expansion',
  ...
  'filiale.trade.name':'TRADE','filiale.trade.full':'BUAME Trade',
  'filiale.trade.desc':"Import-export, B2B distribution, general trade, BUAME Market. Exclusive supplier of the other 5 subsidiaries.",
  'filiale.logistics.name':'LOGISTICS','filiale.logistics.full':'BUAME Logistics',
...
pt: {
  ...
  'groupe.struct.card2':'Construção, Comércio, Logística, Imobiliário, Agro, Média. Cada uma constituída como SASU em Lomé, acionista único: BUAME GROUP SAS.',
  ...
  'filiale.trade.name':'COMERCIO','filiale.trade.full':'BUAME Comércio',
  'filiale.trade.desc':'Importação-exportação, distribuição B2B, comércio geral, BUAME Mercado. Fornecedor exclusivo das outras 5 filiais.',
...
const FILIALE_DATA = {
  fr: {
    ...
    trade: { emoji:'📦', title:'BUAME Trade', desc:'Import-export, distribution B2B, commerce général, BUAME Market. Fournisseur exclusif des 5 autres filiales.', details:'Hub logistique à Lomé. Partenariats avec fournisseurs asiatiques et européens. ZLECAF compliant.', ca:'240 000 000 FCFA (An 3)', synergy:"Fournisseur exclusif des 5 autres filiales du groupe" },
  ...
  en: {
    ...
    trade: { emoji:'📦', title:'BUAME Trade', desc:"Import-export, B2B distribution, general trade, BUAME Market. Exclusive supplier of the other 5 subsidiaries.", details:'Logistics hub in Lomé. Partnerships with Asian and European suppliers. AfCFTA compliant.', ca:'240 000 000 FCFA (Year 3)', synergy:"Exclusive supplier for the group's 5 other subsidiaries" },
  ...
  pt: {
    ...
    trade: { emoji:'📦', title:'BUAME Comércio', desc:'Importação-exportação, distribuição B2B, comércio geral, BUAME Mercado. Fornecedor exclusivo das outras 5 filiais.', details:'Hub logístico em Lomé. Parcerias com fornecedores asiáticos e europeus. Conforme ZLECAF.', ca:'240 000 000 FCFA (Ano 3)', synergy:'Fornecedor exclusivo das outras 5 filiais do grupo' },
